...
var autentificacion_1 = require("../middlewares/autentificacion");
...
// Crear Post
postRoutes.post('/', [autentificacion_1.verificaToken], function (req, res) {
    var body = req.body;
...
postRoutes.post('/upload', [autentificacion_1.verificaToken], function (req, res) { return __awaiter(_this, void 0, void 0, function () {
    var file;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
